...
namespace QuanLyKhachHang.GUI
{
    public partial class Fm_MainForm : Form
    {
        ...
        public Fm_MainForm(string strUsername)
        {
        ...
        private void btnQuanLyKhachHang(object sender, EventArgs e)
        {
            ...
            Fm_CustomerManagement Cus = new Fm_CustomerManagement(StrUsername);
            this.Visible = false;
            Cus.ShowDialog(); ;
            this.Visible = true;
        }
        ...
        {
            Fm_QuanLyDanhMuc FQuanLyDanhMuc = new Fm_QuanLyDanhMuc(StrUsername);
            this.Visible = false;
